...
public class MainActivity extends AppCompatActivity {
    ...
    public void addListenerOnChkWindows() {
        CheckBox windows = (CheckBox) findViewById(R.id.windows_option);
    ...
    public void addListenerOnButton() {
        CheckBox linux = (CheckBox) findViewById(R.id.linux_option);
        CheckBox macos = (CheckBox) findViewById(R.id.macos_option);
        CheckBox windows = (CheckBox) findViewById(R.id.windows_option);
